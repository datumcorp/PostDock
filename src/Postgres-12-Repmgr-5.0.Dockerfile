...
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/r/repmgr/repmgr-common_5.0.0-3.pgdg+1_all.deb"
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/r/repmgr/postgresql-$PG_MAJOR-repmgr_5.0.0-3.pgdg+1_amd64.deb"
